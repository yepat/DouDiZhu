...
Events.Network = {
    ...
    GetRewardListResult : "get_reward_list_result",             //再打几局可以获得的奖励
    GetGameGiftListResult : "get_game_lift_list_result",        //获取礼包列表
    CanDoubleResult : "can_double_result",                      //通知是否可以加倍
    BuyGoodsResult : "buyGoods_result",                         //通知商品是否购买成功
    GetGameFieldResult : "getGameField_result",                 //获取房间信息回调
    GetFieldDetailResult : "getFieldDetail_result",             //获取房间信息回调
    GetMyFieldResult : "getMyField_result",                     //获取房间信息回调
    SignupResult : "Signup_Result",                             //报名回调
    UnSignupResult : "UnSignup_Result",                         //取消报名回调
    GetMatchItemsResult : "GetMatchItems_Result",               //获取竞技奖励列表
    GameMatchStart : "gamematch_start",                         //通知比赛开始
    MatchEliminateResult :"MatchEliminate_Result",  
    EnterHallScence : "EnterHallScenece",
    MatchOrderChangedResult : "MatchOrderChangedResult",
    MatchStartSoonResult : "MatchStartSoonResult",

    MatchEndBagResult : "MatchEndBagResult",                    //比赛结束红包
    FirstgetlequanResult : "FirstgetlequanResult",              //第一次获得乐券
    RedpacketprocessResult : "RedpacketprocessResult",          //红包进度条
    EntergamerestnumResult : "EntergamerestnumResult",          //进入房间红包剩余次数

    RefreshPlayerData          : "RefreshPlayerData",
    GetPlayerMatchesInfo       : "GetPlayerMatchesInfo",//获取总牌局数
    Analysis_log               : "Analysis_log",        //日志分析
    EmoticonData               : "emoticon_data",       //广播表情包
    PokerAnalysis              : "PokerAnalysis" ,       //牌局日志
}
