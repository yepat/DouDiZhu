(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/operate/opratOutCardControl.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
...
cc.Class({
    ...
    // start () {
    // },
    show: function show(time, buchuFunc, tishiFunc, chupaiFunc, type) {
        //type 1必出 2要不起
